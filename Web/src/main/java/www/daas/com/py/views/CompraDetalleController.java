...
public class CompraDetalleController implements Serializable {
    ...
    @EJB
    private www.daas.com.py.sessionbeans.CompraDetalleFacade ejbFacade;
    ...
    public CompraDetalle getCompraDetalle(java.lang.Integer id) {
    ...
    public static class CompraDetalleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof CompraDetalle) {
                ...
                return getStringKey(o.getIdCompraDetalle());
            } else {
